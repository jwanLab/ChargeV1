...
//---------------------------------------------------
bool AliAnalysisTaskMyTask::QC2SE()
{
...
//-----------------------------------------------------
void AliAnalysisTaskMyTask::ResetHists()
{
  hMQ_thisEvt->Reset();
  hReQ_thisEvt->Reset();
  hImQ_thisEvt->Reset();
...
bool AliAnalysisTaskMyTask::GetZDCPlaneLsFit()
{
...
//--------------------------------------------
inline double AliAnalysisTaskMyTask::GetEventPlane(double qx, double qy, double harmonic)
{
...
bool AliAnalysisTaskMyTask::CheckPIDofParticle(AliAODTrack *ftrack, int pidToCheck)
{
  if (pidToCheck == 0)
